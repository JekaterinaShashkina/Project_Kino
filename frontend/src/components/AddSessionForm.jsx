...
const AddSessionForm = ({ initialData = null, onSubmit }) => {
    ...
    // Устанавливаем данные из initialData для редактирования
    useEffect(() => {
        if (initialData) {
            setSelectedMovie(initialData.movieid);
            setSelectedHall(initialData.hallid);
            setStartTime(initialData.starttime);
            setTicketPrice(initialData.price);
        }
    }, [initialData]);
    ...
    return (
        <Box sx={{ p: 4, maxWidth: 450, margin: 'auto', backgroundColor: 'transparent' }}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                >
                    {initialData ? 'SAVE SESSION' : 'CREATE SESSION'}
                </Button>
            </form>
